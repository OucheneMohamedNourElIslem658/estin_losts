...
class UserFoundsScreen extends StatelessWidget {
  const UserFoundsScreen({super.key});
  ...
  Widget build(BuildContext context) {
    final postsPaginationController = Get.put(
      PostsPaginationController(
        ...
        claimedOrFoundByUserID: UserPostRelation.found
      ), 
      tag: 'user-founds'
    );
    ...
    return Scaffold(
      body: NestedScrollView(
        ...
        body: GetBuilder<PostsPaginationController>(
          tag: 'user-founds',
          dispose: (_) => Get.delete<PostsPaginationController>(tag: 'user-founds'),
          builder: (_) {
